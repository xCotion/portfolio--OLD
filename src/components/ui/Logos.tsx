export const Logos = {
  ClaudeLogo: ({ className }: { className?: string }) => {
    return (
      <svg
  ...
  OpenAILogo: ({ className }: { className?: string }) => {
    return (
      <svg
        className={className}
        width="28"
  ...
  GeminiLogo: ({ className }: { className?: string }) => {
    return (
      <svg
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
  ...
  MetaIconOutline: ({ className }: { className?: string }) => {
    return (
      <svg
        id="Layer_1"
        data-name="Layer 1"
